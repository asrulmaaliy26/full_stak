    ...
    <nav className="bg-white border-b border-slate-100 sticky top-0 z-50 shadow-sm transition-all duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="lg:hidden flex items-center gap-2">
            <Link to="/admin" className="p-2 rounded-xl text-slate-500 hover:text-slate-900 bg-slate-50">
              <UserCog className="w-5 h-5" />
            </Link>
            <button
      ...
      {isOpen && (
        <div className="lg:hidden bg-white border-t border-slate-100 py-6 px-4 space-y-4 animate-fadeIn">
          ...
          <Link
            to="/admin"
            className="block px-4 py-3 text-center text-sm font-black rounded-xl bg-slate-100 text-slate-500 hover:text-slate-900 border border-slate-200"
            onClick={() => setIsOpen(false)}
          >
